// Coach Calendar View Manager
import { getCalendarViewPreference, saveCalendarViewPreference } from '../core/storage.js';

export class CoachCalendarManager {
    constructor() {
        this.calendarType = 'coach';
